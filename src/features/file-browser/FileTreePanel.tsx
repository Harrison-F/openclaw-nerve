...
export function FileTreePanel({
  ...
  // When collapsed, the reopen control lives in ChatHeader (desktop) or the
  // drawer toggle (mobile). Rendering a second in-panel rail wastes space and
  // duplicates controls, so hide the panel completely.
  if (collapsed) {
    return null;
  }
